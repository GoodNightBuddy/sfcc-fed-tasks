...
/**
  * Helper object for custom.CreateInvetoryListPNavrotskyi step
...
var listHelper = {
    ...
    */
     ...
     * @param {string} lisId - id which will be assigned tho the list
     * @returns {void}
    */
...
/**
  ...
  * @param {Object} parameters - provided parameters from custom step
  * @returns {void}
*/
